...
{
    /**
     * Get all of the skus for the HasVariants
     *
    ...
    /**
     * Get all of the variants for the HasVariants
     *
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     */
    ...
    public function addVariant($variant)
    {
        ...
        try {
            ...
            throw new InvalidAttributeException($e->getmessage(), 404);
        } catch(Exception $e) {
            DB::rollback();

            throw new InvalidVariantException($e->getMessage(), 400);
        }
