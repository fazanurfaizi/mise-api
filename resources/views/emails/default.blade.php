                ...
                <table class="w-600 w-full"
                    ...
                    <tr>
                        <td align="center"
                            ...
                            &copy; <?php echo date("Y"); ?> {{ config('app.name') }} All Rights Reserved<br>
                            URL: <a href="{{ config('app.url') }}">{{ config('app.url') }}</a> Email: <a href="mailto:{{ config('mail.from.address') }}">{{ config('mail.from.address') }}</a>
